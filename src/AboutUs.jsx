...
const About = () => {
  return (
    <div
      id="about-us"
      className="flex flex-col lg:flex-row -mt-32  h-[832px] lg:-mt-0 relative overflow-hidden"
    >
      {/* Image Container */}
      ...
      <div className="relative w-full lg:w-1/3 lg:top-[16rem]  px-4 lg:px-6 mt-8 lg:mt-0">
        ...
        >
          ...
          <p className="text-[#1F2456] absolute top-[30rem] lg:top-[1rem] lg:right-[12rem]  font-light text-center lg:text-left lg:pl-6">
