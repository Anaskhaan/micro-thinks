...
const Hero = ({ slidetoContactForm }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      title: (
        <>
          <span className="text-[#1F2456] font-bold">Google Ads </span>
    ...
    },
    {
      ...
      title: (
        <>
          <span className="text-[#1F2456] font-bold">OTA Listing </span>
          <span className="text-[#F89522]">Management</span>
        </>
      ),
    ...
    },
    {
      ...
      title: (
        <>
          <span className="text-[#1F2456] font-bold">Custom Web </span>
              ...
              currentSlide === index && (
                ...
                >
                  ...
                  <div className="space-y-4 text-left lg:order-1 lg:ml-16">
                    <motion.h1
                      className="font-bold tracking-wider mt-1 xl:mt-4 w-full  text-5xl .heading-h1"
